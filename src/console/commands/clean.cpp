...
zephir::console::commands::CleanCommand::CleanCommand(std::string name)
    : AbstractCommand(std::move(name)) {}

void zephir::console::commands::CleanCommand::Setup(CLI::App_p app) {
...
void zephir::console::commands::CleanCommand::Execute() {
  // Do stuff...
