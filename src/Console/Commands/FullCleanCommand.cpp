...
#include "FullCleanCommand.hpp"

#include <utility>

zephir::console::commands::FullCleanCommand::FullCleanCommand(std::string name)
    : AbstractCommand(std::move(name)) {}

void zephir::console::commands::FullCleanCommand::Setup(CLI::App_p app) {
...
void zephir::console::commands::FullCleanCommand::Execute() {
  // Do stuff...
