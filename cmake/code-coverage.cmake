...
#
# In this case, the coverage information reported will be that of the `theLib`
# library target and `theExe` executable.
#
    ...
    if(CODE_COVERAGE)
        ...
        if(target_type STREQUAL "EXECUTABLE")
            if(CMAKE_COMPILER_IS_CLANG OR CMAKE_COMPILER_IS_APPLE_CLANG)
                ...
                # If there are shared objects to also work with, generate the
                ...
                # Print out details of the coverage information to the command
                # line
                ...
                # Print out a summary of the coverage information to the command
                # line
...
function(add_code_coverage)
    ...
    elseif(CMAKE_COMPILER_IS_GNUCXX)
        ...
        link_libraries(gcov)
    elseif(MSVC)
        # TODO(klay): what kind of flags are needed to profile on MSVC?
        message(
            FATAL_ERROR "Code coverage builds not supported on current platform"
            )
    endif()
endfunction()
