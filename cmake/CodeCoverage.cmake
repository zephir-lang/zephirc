...
macro(ensure_built_type)
  set(ccovWarn "Code coverage results with an optimised (non-Debug) build may be misleading")
...
function(setup_code_coverage_target)
  ...
  set(multiValues  EXECUTABLE EXECUTABLE_ARGS DEPENDENCIES LCOV_ARGS GENHTML_ARGS)

  # Process the arguments passed in
  include(CMakeParseArguments)

  cmake_parse_arguments(${prefix}
    "${noValues}" "${singleValues}" "${multiValues}" ${ARGN})
  ...
  add_custom_target(ccov-clean
    ...
    COMMAND ${LCOV_EXECUTABLE} ${ARG_LCOV_ARGS}
  ...
  add_custom_target(${ARG_NAME}
    ...
    COMMAND ${LCOV_EXECUTABLE} ${ARG_LCOV_ARGS}
            --gcov-tool ${GCOV_EXECUTABLE}
            --directory ${CMAKE_BINARY_DIR}
            --capture --output-file ${CCOV_OUTPUT_DIRECTORY}/${ARG_NAME}.info
    COMMAND ${LCOV_EXECUTABLE} ${ARG_EXECUTABLE_ARGS}
            --gcov-tool ${GCOV_EXECUTABLE}
  ...
  add_custom_command(TARGET ccov-html POST_BUILD
    COMMAND ;
    COMMENT "Open ${CCOV_OUTPUT_DIRECTORY}/index.html in your browser to view the coverage report.")
endfunction()
