...
#
# which creates a custom commands to generate the <Output> file from the <Input>
...
#
# add_executable(Foo Foo.cpp) target_link_libraries(Foo PRIVATE MyScanner)
#
# The module defines the following variables:
#
# RE2C_EXECUTABLE - the path to the re2c executable RE2C_VERSION    - version of
# the re2c
...
if(RE2C_EXECUTABLE)
  ...
  # RE2C_TARGET (public macro) TODO - rework this macro to make use of
  # CMakeParseArguments, see
  ...
  if(NOT COMMAND RE2C_TARGET)
    macro(RE2C_TARGET Name Input Output)
      if(${ARGC} GREATER 3)
        if(${ARGC} EQUAL 5)
          if("${ARGV3}" STREQUAL "COMPILE_FLAGS")
            ...
            message(SEND_ERROR "Invalid RE2C_TARGET usage: Incorrect ARGV3")
          endif()
        else()
          message(SEND_ERROR "Invalid RE2C_TARGET usage: Incorrect ARGC value")
        endif()
      endif()
      ...
      add_custom_command(
        ...
        COMMENT
          "[RE2C][${Name}] Building scanner with ${RE2C_EXECUTABLE} v${RE2C_VERSION}"
