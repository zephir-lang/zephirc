...
if(CLANG_FORMAT_EXE)
  message(STATUS "Check for clang-format: ${CLANG_FORMAT_EXE}")
else()
...
if(CMAKE_FORMAT_EXE)
  message(STATUS "Check for cmake-format: ${CMAKE_FORMAT_EXE}")
else()
  message(STATUS "Check for cmake-format: not found")
endif()
